...
namespace SCDR.InitiativesSliderAr
{
    [ToolboxItemAttribute(false)]
    public partial class InitiativesSliderAr : WebPart
    {
        public InitiativesSliderAr()
        {
        }
        ...
        private const string DefaultHeading = "مبادراتنا";
        ...
        private const string DefaultAnchorText = "اقرأ المزيد";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!((Page)System.Web.HttpContext.Current.CurrentHandler).IsPostBack)
            {
                ...
                lab.Text = InitiativesSliderAr.headingName;
        ...
        protected void repOurInitiativesSlider_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                anchor.InnerText = InitiativesSliderAr.anchorText;
            }
        }
