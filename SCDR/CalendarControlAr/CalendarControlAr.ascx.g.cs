    ...
    <div class=""modal-content"">
        ...
        $(document).ready(function () {
            ...
            @__w.Write("\").click();\r\n                //  $(\"#<=txtSelectedDate.ClientID%>\").ontextchanged" +
                    ...
                    "\r\n            format: \'m/d/yyyy\',\r\n            autoclose: true,\r\n        });\r\n  " +
                    "      $(\'#date_pair\').datepair();\r\n\r\n        dispevent();\r\n        day_rows();\r\n" +
                    "        day_four_rows();\r\n    });\r\n\r\n    $(document).on(\"change\", \".ic__month-se" +
                    "lect\", function () {\r\n        dispevent();\r\n        day_rows();\r\n        day_fou" +
                    "r_rows();\r\n    });\r\n    $(document).on(\"change\", \".ic__year-select\", function ()" +
                    " {\r\n        dispevent();\r\n        day_rows();\r\n        day_four_rows();\r\n    });" +
                    "\r\n    $(document).on(\"click\", function () {\r\n        dispevent();\r\n        day_r" +
                    "ows();\r\n        day_four_rows();\r\n    });\r\n    $(document).on(\"click\", \".event-n" +
                    "ame\", function () {\r\n        if ($(this).parent().find(\".event-expand-details\")." +
                    "is(\":hidden\")) {\r\n            $(\".expand-event\").removeClass(\"expand-event\");\r\n " +
                    "           $(\".event-expand-details\").slideUp();\r\n            $(this).addClass(\"" +
                    "expand-event\");\r\n            $(this).parent().find(\".event-expand-details\").slid" +
                    "eDown();\r\n        }\r\n        else {\r\n            $(this).removeClass(\"expand-eve" +
                    "nt\");\r\n            $(\".event-expand-details\").slideUp();\r\n        }\r\n    });\r\n  " +
                    "  $(document).on(\"click\", \".search-event-title\", function () {\r\n        $(\".sear" +
                    "ch-event-form\").slideToggle();\r\n    });\r\n    $(document).on(\"click\", \".event-clo" +
                    "se-popup\", function () {\r\n        $(\".popupbg_event\").fadeOut(200);\r\n        $(\"" +
                    ".popup_container_event\").fadeOut(150);\r\n        $(\".expand-event\").removeClass(\"" +
                    "expand-event\");\r\n        $(\".event-expand-details\").hide();\r\n        $(\".search-" +
                    "event-form\").hide();\r\n    });\r\n    $(document).on(\"click\", \".popupbg_event\", fun" +
                    "ction () {\r\n        $(\".popupbg_event\").fadeOut(200);\r\n        $(\".popup_contain" +
                    "er_event\").fadeOut(150);\r\n        $(\".expand-event\").removeClass(\"expand-event\")" +
                    ";\r\n        $(\".event-expand-details\").hide();\r\n        $(\".search-event-form\").h" +
                    "ide();\r\n    });\r\n\r\n</script>\r\n\r\n<script type=\"text/javascript\" src=\"../../_layou" +
                    "ts/15/SCDR/js/bootstrap-datepicker.min.js\" ></script>\r\n <script type=\"text/javas" +
                    "cript\">\r\n     $(document).ready(function () {\r\n         $(\'#txtStartDate\')\r\n    " +
                    "         .datepicker({\r\n                 format: \'dd/MM/yyyy\',\r\n                " +
                    " todayHighlight: true,\r\n\r\n             });\r\n         $(\'#txtEndDate\')\r\n         " +
                    "  .datepicker({\r\n               format: \'dd/MM/yyyy\',\r\n               todayHighl" +
                    "ight: true,\r\n\r\n           });\r\n\r\n     });\r\n    </script>\r\n<style>\r\n.datepicker{z" +
                    "-index:55000 !important;}\r\n</style>\r\n<script src=\"../_layouts/15/SCDR/js/html2ca" +
                    "nvas.js\"></script>\r\n<script src=\"../_layouts/15/SCDR/js/canvas2image.js\"></scrip" +
                    "t>\r\n<script src=\"../_layouts/15/SCDR/js/jspdf.min.js\"></script>\r\n<!--Modal Popup" +
                    " download as PDF, print div and Email Event Details -->\r\n<script type=\"text/java" +
                    "script\">\r\n    function printSelectedDiv(event) {\r\n    \r\n        var frame1 = $(\'" +
                    "<iframe />\');\r\n        frame1[0].name = \"frame1\";\r\n        frame1.css({ \"positio" +
                    "n\": \"absolute\", \"top\": \"-1000000px\" });\r\n        $(\"body\").append(frame1);\r\n    " +
                    "    var frameDoc = frame1[0].contentWindow ? frame1[0].contentWindow : frame1[0]" +
                    ".contentDocument.document ? frame1[0].contentDocument.document : frame1[0].conte" +
                    "ntDocument;\r\n        frameDoc.document.open();\r\n        //Create a new HTML docu" +
                    "ment.\r\n       \r\n        $div = $(event.target).closest(\".event-view-wrapper\");\r\n" +
                    "        var textTitle = $div.children(\".event-name\").text();\r\n        var textDa" +
                    "te = $div.children(\".event-expand-details\").children(\".event-details-container\")" +
                    ".children(\".event-info-wrapper\").children(\".event-info:nth-child(2)\").find(\'span" +
                    "\').text();\r\n        var textTime = $div.children(\".event-expand-details\").childr" +
                    "en(\".event-details-container\").children(\".event-info-wrapper\").children(\".event-" +
                    "info:nth-child(3)\").find(\'span\').text();\r\n        var textVenue = $div.children(" +
                    "\".event-expand-details\").children(\".event-details-container\").children(\".event-i" +
                    "nfo-wrapper\").children(\".event-info:nth-child(1)\").find(\'span\').text();\r\n       " +
                    " var textDepartment = $div.children(\".event-expand-details\").children(\".event-de" +
                    "tails-container\").children(\".event-info-wrapper\").children(\".event-info:nth-chil" +
                    "d(4)\").find(\'span\').text();\r\n        var textDescription = $div.children(\".event" +
                    "-expand-details\").children(\".event-details-container\").find(\'p\').text();\r\n      " +
                    "  var textImageUrl = $div.children(\".event-expand-details\").children(\".event-det" +
                    "ails-container\").children(\".event-img-wrapper\").find(\'img\').attr(\"src\");\r\n      " +
                    "  var contentTable = \"<table><tr><td>حدث: </td><td>\" + textTitle + \"</td></tr>\";" +
                    "\r\n        contentTable += \"<tr><td>مكان الحدث:</td><td>\" + textVenue + \"</td></t" +
                    "r>\";\r\n        contentTable += \"<tr><td>تاريخ الحدث:</td><td>\" + textDate + \"</td" +
                    "></tr>\";\r\n        contentTable += \"<tr><td>وقت الحدث:</td><td style=\" + \"\\\"\" + \"" +
                    "dir:ltr\" + \"\\\"\" + \">\" + textTime.replace(/\\s/g, \'\') + \"</td></tr>\";\r\n        con" +
                    "tentTable += \"<tr><td>قسم:</td><td>\" + textDepartment + \"</td></tr></table>\";\r\n " +
                    "       contentTable += \"<img src=\" + textImageUrl + \">\";\r\n        contentTable +" +
                    "= \"<p>\" + textDescription + \"</p>\";\r\n        //Create a new HTML document.\r\n    " +
                    "    frameDoc.document.write(\'<html><head><title>Event Details</title>\');\r\n      " +
                    "  frameDoc.document.write(\'<style>body{direction:rtl;}img{width:200px;height:200" +
                    "px}table {width: auto;}tr td {white-space: nowrap;word-wrap:break-word;}</style>" +
                    "\');\r\n        frameDoc.document.write(\'</head><body>\');\r\n        //Append CSS her" +
                    "e\r\n        //Append the DIV contents.\r\n        frameDoc.document.write(contentTa" +
                    ...
                    "mailSelectedDiv(event) {\r\n        $div = $(event.target).closest(\".event-view-wr" +
                    "apper\");\r\n        var textTitle = $div.children(\".event-name\").text();\r\n        " +
                    "var textDate = $div.children(\".event-expand-details\").children(\".event-details-c" +
                    "ontainer\").children(\".event-info-wrapper\").children(\".event-info:nth-child(2)\")." +
                    "find(\'span\').text();\r\n        var textTime = $div.children(\".event-expand-detail" +
                    "s\").children(\".event-details-container\").children(\".event-info-wrapper\").childre" +
                    "n(\".event-info:nth-child(3)\").find(\'span\').text();\r\n        var url = window.loc" +
                    "ation.href;\r\n        var formattedBody = \"\\nEvent Date : \" + textDate + \"\\n\\nEve" +
                    "nt Time : \" + textTime + \"\\n\\nFor more details, visit \" + url;\r\n\r\n        var ma" +
                    "ilToLink = \"mailto:?\";\r\n        var mailContent = \"Subject=\" + textTitle + \"&\";\r" +
                    "\n        mailContent += \"body=\" + encodeURIComponent(formattedBody);\r\n\r\n        " +
                    "$(event.target).attr(\"href\", mailToLink + mailContent);\r\n        window.location" +
                    " = $(event.target).attr(\'href\');\r\n\r\n    }\r\n\r\n\r\n\r\n\r\n\r\n\r\n </script>    \r\n\r\n \r\n<!--" +
                    " Panel Refresh-->\r\n <script type=\"text/javascript\">\r\n     // if you use jQuery, " +
                    "you can load them when dom is read.\r\n     $(document).ready(function () {\r\n     " +
                    "    var prm = Sys.WebForms.PageRequestManager.getInstance();\r\n         prm.add_i" +
                    "nitializeRequest(InitializeRequest);\r\n         prm.add_endRequest(EndRequest);\r\n" +
                    ...
                    " = Sys.WebForms.PageRequestManager.getInstance(); if (!prm.get_isInAsyncPostBack" +
                    "()) {\r\n\r\n             prm.add_pageLoaded(SPCustomPageLoaded);\r\n\r\n             //" +
                    " wire up loaded handler.\r\n\r\n         }\r\n\r\n     }\r\n\r\n     function SPCustomPageLo" +
