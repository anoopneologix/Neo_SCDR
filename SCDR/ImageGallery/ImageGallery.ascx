...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ImageGallery.ascx.cs" Inherits="SCDR.ImageGallery.ImageGallery" %>
...
<asp:Repeater ID="repGroupName" runat="server" OnItemDataBound="repGroupName_ItemDataBound">
    <HeaderTemplate>
<h4 class="gallery_title">Image Gallery</h4>
    </HeaderTemplate>
<ItemTemplate>
                ...
                <div class="col-md-4 col-xs-12 col-sm-6 gallery-image-thumb">
                    ...
                    <div class="gallerydes"><%# Eval("dtTitle") %></div>
                </div>
