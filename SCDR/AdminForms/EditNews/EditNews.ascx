...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EditNews.ascx.cs" Inherits="SCDR.AdminForms.EditNews.EditNews" %>
<div class="col-md-12 col-sm-12 col-xs-12">
     <div class=" col-md-12"> 
     <asp:LinkButton ID="lbAddNews" runat="server" OnClick="lbAddNews_Click"  ><span class="glyphicon glyphicon-plus" aria-hidden="true"></span>Add News</asp:LinkButton>
  </div>
    ...
    <div class=" col-md-12"> 
<asp:GridView ID="gdvNews" class="table table-hover table-striped" runat="server" AutoGenerateColumns="False" OnRowCommand="gdvNews_RowCommand"  >
    <Columns>
