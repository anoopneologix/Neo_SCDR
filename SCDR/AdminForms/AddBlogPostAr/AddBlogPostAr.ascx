...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddBlogPostAr.ascx.cs" Inherits="SCDR.AdminForms.AddBlogPostAr.AddBlogPostAr" %>
...
<div class="form-group">
  ...
  <div class="form-group">
    <div class="col-sm-offset-3 col-sm-9">
        <asp:Button ClientIDMode="Static"  ID="btnSubmit" Text="submit" ValidationGroup="chk" class="btn btn-default" runat="server" OnClick="btnSubmit_Click"   />
    </div>
  </div>
   </div>
