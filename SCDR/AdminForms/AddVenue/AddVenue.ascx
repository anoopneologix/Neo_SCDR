...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddVenue.ascx.cs" Inherits="SCDR.AdminForms.AddVenue.AddVenue" %>
<div class="col-md-12 col-sm-12 col-xs-12">
 ...
 <asp:RegularExpressionValidator ID="RegularExpressionValidator6" ValidationExpression="^[0-9a-zA-Z ]+$" 
    ...
    <div class="col-sm-6">
        <asp:FileUpload ID="fuVenueIcon" runat="server" />
    </div>
    <div class="col-sm-3">
    ...
    ControlToValidate="fuVenueIcon"  runat="server" ForeColor="Red" ErrorMessage="Please select a valid image file of type .jpg,.jpeg,.png."
    Display="Dynamic" />
    </div>
