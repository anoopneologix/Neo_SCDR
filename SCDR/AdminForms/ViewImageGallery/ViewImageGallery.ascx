...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ViewImageGallery.ascx.cs" Inherits="SCDR.AdminForms.ViewImageGallery.ViewImageGallery" %>
<div class="col-md-12 col-sm-12 col-xs-12">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
     ...
     <table >
      ...
      <div class=" col-md-12"> 
          <asp:GridView ID="gdvImageGallery" class="table table-hover table-striped" runat="server" AutoGenerateColumns="False" AllowPaging="True"  PageSize="30" OnPageIndexChanging="gdvImageGallery_PageIndexChanging">
              <Columns>
