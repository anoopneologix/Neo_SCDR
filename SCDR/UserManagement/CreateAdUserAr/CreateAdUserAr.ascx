  ...
  <div class="form-group">
    ...
    <div class="col-sm-5">
     <asp:TextBox ID="txtLastName" CausesValidation="true"  CssClass="form-control" ClientIDMode="Static" runat="server"></asp:TextBox>
              ...
              <asp:RegularExpressionValidator ID="RegularExpressionValidator3" ForeColor="Red" Display="Dynamic" ValidationGroup="chk" ValidationExpression="^[a-zA-Z]{0,50}$" ControlToValidate="txtLastName"  runat="server" ErrorMessage="أقصى 50 الأحرف المسموح، أي أحرف خاصة وأرقام سمحت"></asp:RegularExpressionValidator>
                     </div>
  </div>
        <div class="form-group">
    ...
    <div class="col-sm-5">
     <asp:TextBox ID="txtPhoneNumber" CausesValidation="true" CssClass="form-control" ClientIDMode="Static" runat="server"></asp:TextBox>
              ...
              <div class="col-sm-5">
                  ...
                  <asp:RegularExpressionValidator ForeColor="Red" ValidationGroup="chk" ID="RegularExpressionValidator1" Display="Dynamic" runat="server" ControlToValidate="txtPhoneNumber" ValidationExpression="^\s*\+?[0-9]\d?[- .]?(\([2-9]\d{2}\)|[2-9]\d{2})[- .]?\d{3}[- .]?\d{4}$"   ErrorMessage="يرجى إدخال رقم الهاتف الصحيح."></asp:RegularExpressionValidator>       
                   </div>
  </div>
    ...
    ErrorMessage="الحد الأدنى من 8 أحرف على الأقل 1 الأبجدية و1 عدد و1 حرف خاص" ForeColor="Red" ></asp:RegularExpressionValidator>
                   </div>
  </div>
         <div class="form-group">
  ...
  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
      <asp:Button ID="btnRegister" CssClass="btn btn-default" ValidationGroup="chk" runat="server" Text="تسجيل" OnClick="btnRegister_Click"  />
         <asp:Button ID="btncancel" CssClass="btn btn-default" runat="server" Text="ألغى" OnClick="btncancel_Click"  />
    </div>
  </div>
</div>
    </div>
