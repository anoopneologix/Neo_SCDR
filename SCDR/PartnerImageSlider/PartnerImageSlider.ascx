...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PartnerImageSlider.ascx.cs" Inherits="SCDR.PartnerImageSlider.PartnerImageSlider" %>
...
<asp:Repeater ID="repPartnerSlider" runat="server">
    <HeaderTemplate>
            ...
            <div class="outerpartner">
                ...
                <div class="eng_partner_carousel">
    </HeaderTemplate>
    <ItemTemplate>
