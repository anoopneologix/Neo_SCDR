    ...
    $(document).ready(function () {
        ...
        $(document).ready(function () {
            ...
            @__w.Write("\").click();\r\n                //  $(\"#<=txtSelectedDate.ClientID%>\").ontextchanged" +
                    ...
                    "ailSelectedDiv(event) {\r\n        $div = $(event.target).closest(\".event-view-wra" +
                    "pper\");\r\n        var textTitle = $div.children(\".event-name\").text();\r\n        v" +
                    "ar textDate = $div.children(\".event-expand-details\").children(\".event-details-co" +
                    "ntainer\").children(\".event-info-wrapper\").children(\".event-info:nth-child(2)\").f" +
                    ...
                    "Refresh-->\r\n <script type=\"text/javascript\"> \r\n     // if you use jQuery, you ca" +
                    "n load them when dom is read.\r\n     $(document).ready(function () {\r\n         va" +
                    "r prm = Sys.WebForms.PageRequestManager.getInstance();    \r\n         prm.add_ini" +
                    "tializeRequest(InitializeRequest);\r\n         prm.add_endRequest(EndRequest);\r\n\r\n" +
                    "     });        \r\n\r\n     function InitializeRequest(sender, args) {\r\n      \r\n   " +
                    "  }\r\n\r\n     function EndRequest(sender, args) \r\n     {\r\n         //calendar scri" +
                    "pt\r\n      \r\n         $(function () {\r\n             $(\".kalendar\").ionCalendar({\r" +
                    "\n                 lang: \"en\",\r\n                 //years: \"1915-1995\",\r\n         " +
                    "        onClick: function (date) {\r\n                     //  dispevent();\r\n     " +
                    "            }\r\n             });\r\n          /*   var today = new Date();\r\n       " +
                    "      var dd = today.getDate();\r\n             var mm = today.getMonth() + 1;\r\n  " +
                    ...
                    "nager.getInstance(); if (!prm.get_isInAsyncPostBack())\r\n\r\n{\r\n\r\nprm.add_pageLoade" +
                    "d(SPCustomPageLoaded);\r\n\r\n// wire up loaded handler.\r\n\r\n}\r\n\r\n}\r\n\r\nfunction SPCus" +
                    "tomPageLoaded(sender, args) {\r\n\r\n// put the original title back on the document." +
