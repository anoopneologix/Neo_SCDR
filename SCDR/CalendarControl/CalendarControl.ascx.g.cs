    ...
    $(document).ready(function () {
        ...
        $(document).ready(function () {
            ...
            @__w.Write("\").click();\r\n                //  $(\"#<=txtSelectedDate.ClientID%>\").ontextchanged" +
                    ...
                    "lectedDiv(event) {\r\n        $div = $(event.target).closest(\".event-view-wrapper\"" +
                    ");\r\n        var textTitle = $div.children(\".event-name\").text();\r\n        var te" +
                    "xtDate = $div.children(\".event-expand-details\").children(\".event-details-contain" +
                    "er\").children(\".event-info-wrapper\").children(\".event-info:nth-child(2)\").find(\'" +
                    "span\').text();\r\n        var textTime = $div.children(\".event-expand-details\").ch" +
                    "ildren(\".event-details-container\").children(\".event-info-wrapper\").children(\".ev" +
                    "ent-info:nth-child(3)\").find(\'span\').text();\r\n        var url = window.location." +
                    "href;\r\n        var formattedBody = \"\\nEvent Date : \" + textDate + \"\\n\\nEvent Tim" +
                    "e : \" + textTime + \"\\n\\nFor more details, visit \" + url;\r\n\r\n        var mailToLi" +
                    "nk = \"mailto:?\";\r\n        var mailContent = \"Subject=\" + textTitle + \"&\";\r\n     " +
                    "   mailContent += \"body=\" + encodeURIComponent(formattedBody);\r\n\r\n        $(even" +
                    "t.target).attr(\"href\", mailToLink + mailContent);\r\n        window.location = $(e" +
                    "vent.target).attr(\'href\');\r\n\r\n    }\r\n\r\n </script>   \r\n\r\n\r\n \r\n \r\n<!-- Panel Refre" +
                    "sh-->\r\n <script type=\"text/javascript\"> \r\n     // if you use jQuery, you can loa" +
                    "d them when dom is read.\r\n     $(document).ready(function () {\r\n         var prm" +
                    " = Sys.WebForms.PageRequestManager.getInstance();    \r\n         prm.add_initiali" +
                    "zeRequest(InitializeRequest);\r\n         prm.add_endRequest(EndRequest);\r\n\r\n     " +
