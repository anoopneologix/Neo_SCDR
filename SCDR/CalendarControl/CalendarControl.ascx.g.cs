    ...
    $(document).ready(function () {
        ...
        $(document).ready(function () {
            ...
            @__w.Write("\").click();\r\n                //  $(\"#<=txtSelectedDate.ClientID%>\").ontextchanged" +
                    ...
                    ") {\r\n        $div = $(event.target).closest(\".event-view-wrapper\");\r\n        var" +
                    " textTitle = $div.children(\".event-name\").text();\r\n        var textDate = $div.c" +
                    "hildren(\".event-expand-details\").children(\".event-details-container\").children(\"" +
                    ".event-info-wrapper\").children(\".event-info:nth-child(2)\").find(\'span\').text();\r" +
                    "\n        var textTime = $div.children(\".event-expand-details\").children(\".event-" +
                    "details-container\").children(\".event-info-wrapper\").children(\".event-info:nth-ch" +
                    "ild(3)\").find(\'span\').text();\r\n        var url = window.location.href;\r\n        " +
                    "var formattedBody = \"\\nEvent Date : \" + textDate + \"\\n\\nEvent Time : \" + textTim" +
                    "e + \"\\n\\nFor more details, visit \" + url;\r\n\r\n        var mailToLink = \"mailto:?\"" +
                    ";\r\n        var mailContent = \"Subject=\" + textTitle + \"&\";\r\n        mailContent " +
                    "+= \"body=\" + encodeURIComponent(formattedBody);\r\n\r\n        $(event.target).attr(" +
                    "\"href\", mailToLink + mailContent);\r\n        window.location = $(event.target).at" +
                    "tr(\'href\');\r\n\r\n    }\r\n\r\n </script>    \r\n<!-- Panel Refresh-->\r\n <script type=\"te" +
                    "xt/javascript\"> \r\n     // if you use jQuery, you can load them when dom is read." +
                    "\r\n     $(document).ready(function () {\r\n         var prm = Sys.WebForms.PageRequ" +
                    "estManager.getInstance();    \r\n         prm.add_initializeRequest(InitializeRequ" +
                    "est);\r\n         prm.add_endRequest(EndRequest);\r\n\r\n     });        \r\n\r\n     func" +
                    "tion InitializeRequest(sender, args) {\r\n      \r\n     }\r\n\r\n     function EndReque" +
                    "st(sender, args) \r\n     {\r\n         //calendar script\r\n      \r\n         $(functi" +
                    "on () {\r\n             $(\".kalendar\").ionCalendar({\r\n                 lang: \"en\"," +
                    "\r\n                 //years: \"1915-1995\",\r\n                 onClick: function (da" +
                    "te) {\r\n                     //  dispevent();\r\n                 }\r\n             }" +
