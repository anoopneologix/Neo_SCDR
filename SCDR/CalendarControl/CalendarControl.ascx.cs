//--------------------------------------------------
// Project Name : SCDR
// Program Name : Calender with Event Deatils (Visual WebPart)
...
namespace SCDR.CalendarControl
{
    ...
    public partial class CalendarControl : WebPart
    {
        ...
        private const string DefaultHeading = "Calendar";
        ...
        private const string DefaultbtnToday = "Today";
        ...
        private const string DefaultbtnTodayEvents = "Today's Events";
        ...
        private const string DefaultEventVenue = "Event Venue :";
        ...
        private const string DefaultEventDate = "Event Date :";
        ...
        private const string DefaultEventTime = "Event Time :";
        ...
        private const string DefaultEventDepartment = "Event Department :";
        ...
        // Fuction for loading the Our Initatives Slider on Page Load
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
               // this.BindDummyItem();
                lblHeading.Text = CalendarControl.headingName;
                btnToday.InnerHtml = CalendarControl.buttonToday;
                btnTodayEvents.Text = CalendarControl.buttonTodayEvents;
        ...
        // Function to perform the event b/w dates
        ...
        protected void repEventDetails_ItemDataBound(object sender, System.Web.UI.WebControls.RepeaterItemEventArgs e)
        {
