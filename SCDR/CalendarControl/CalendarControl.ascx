...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CalendarControl.ascx.cs" Inherits="SCDR.CalendarControl.CalendarControl" %>
...
<div class="event-search-wrapper">
  ...
  <!--   <asp:Button  ID="btnClear" CssClass="btn btn-info"   class="event-search" runat="server" Text="clear" OnClick="btnClear_Click"  />-->
   ...
   <asp:RequiredFieldValidator ID="rq1" ClientIDMode="Static" runat="server" ErrorMessage="Required Field" ControlToValidate="txtSearch" ValidationGroup="chk"></asp:RequiredFieldValidator>
     ...
     <asp:RequiredFieldValidator ID="rq2" ClientIDMode="Static" runat="server" ErrorMessage="Required Field" ControlToValidate="txtStartDate" ValidationGroup="chk"></asp:RequiredFieldValidator>
                        </div>
                    </div>
        ...
        <asp:RequiredFieldValidator ID="rq3" ClientIDMode="Static" runat="server" ErrorMessage="Required Field" ControlToValidate="txtEndDate" ValidationGroup="chk"></asp:RequiredFieldValidator>
                            </div>
                    </div>
                </div>
            ...
            <asp:Repeater ID="repEventDetails" EnableViewState="False" runat="server" OnItemDataBound="repEventDetails_ItemDataBound">
               <ItemTemplate>
...
<script type="text/javascript">
    function printSelectedDiv(event) {
        ...
        var contentTable = "<table><tr><td>Name : </td><td>" + textTitle + "</td></tr>";
        contentTable += "<tr><td>Venue : </td><td>" + textVenue + "</td></tr>";
        contentTable += "<tr><td>Date : </td><td>" + textDate + "</td></tr>";
        contentTable += "<tr><td>Time :</td><td style=" + "\"" + "dir:ltr" + "\"" + ">" + textTime.replace(/\s/g, '') + "</td></tr>";
        contentTable += "<tr><td>Department:</td><td>" + textDepartment + "</td></tr></table>";
        ...
        frameDoc.document.write('<style>body{direction:ltr;}img{width:200px;height:200px}table {width: auto;}tr td {white-space: nowrap;word-wrap:break-word;}</style>');
