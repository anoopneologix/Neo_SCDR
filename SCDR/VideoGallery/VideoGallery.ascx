...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="VideoGallery.ascx.cs" Inherits="SCDR.VideoGallery.VideoGallery" %>
  <h4 class="gallery_title">Video Gallery</h4>
