...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ImageGalleryUpload.ascx.cs" Inherits="SCDR.Image_Gallery.ImageGalleryUpload.ImageGalleryUpload" %>
<!-- Form Begins -->
...
<div class="form-group">
  ...
  <div class="form-group">
    <div class="col-sm-offset-3 col-sm-9">
        <asp:Button ID="btnSubmit" Text="submit" class="btn btn-default" runat="server"  />
    </div>
  </div>
  ...
  <div class="col-xs-6 col-md-3">
    <a id="thubUrl" href='<%# Eval("ImageUrl") %>'  class="thumbnail thumbLink">
      ...
      <div class="modal-footer">
          ...
          <asp:Button ID="btnSaveThumbnail" class="btn btn-primary" runat="server" Text="Save"  />
        </div>
    </div>
  </div>
</div>
