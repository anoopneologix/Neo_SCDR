...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RatingAndFeedBack.ascx.cs" Inherits="SCDR.RatingAndFeedBack.RatingAndFeedBack" %>
 <!--floating menu area-->
    ...
    ControlToValidate="txtFeedback" ValidationGroup="chkFeedback"  runat="server" ForeColor="Red" ErrorMessage="only english albhabets and numbers allowed."
    Display="Dynamic" />
                           
                            <asp:Button ID="btnSUbmit"  usesubmitbehavior="false" Text="Submit" ValidationGroup="chkFeedback"   CssClass="btn btn-warning" runat="server" OnClick="btnSUbmit_Click" />
                        </div>
                        <div id="divButton" runat="server">
                                <hr />
<asp:Button ID="btnAnonymosSubmit"  usesubmitbehavior="false" CssClass="btn btn-warning" Text="Submit" runat="server" OnClick="btnAnonymosSubmit_Click"  />
                        </div>
                    </div>
                </div>
