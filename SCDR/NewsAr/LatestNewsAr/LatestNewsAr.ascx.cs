...
namespace SCDR.NewsAr.LatestNewsAr
{
    [ToolboxItemAttribute(false)]
    public partial class LatestNewsAr : WebPart
    {
         public LatestNewsAr()
        {
        }
        ...
        private const string DefaultHeading = "آخر الأخبار";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!((Page)System.Web.HttpContext.Current.CurrentHandler).IsPostBack)
            {
                ...
                lblHeading.Text = LatestNewsAr.headingName;
            }
        }
